...
export default {
    components: {
        ListData: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/fileServer/List.vue'),
            loadingComponent: SkeletonBox,
        }),
        AddData: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/fileServer/Add.vue'),
            loadingComponent: SkeletonBox,
        }),
            ...
            setTimeout(async () => {
                switch (paramsObject.viewName) {
                    ...
                    case 'AddData':
                        viewSettings.value = {
                            viewName: 'AddData',
                            title: 'Thêm mới File Data Source',
                            dataItem: null,
                        };
                        break;
                    case 'ModifyData':
                        viewSettings.value = {
                            viewName: 'ModifyData',
                            title: 'Chỉnh sửa File Data Source',
