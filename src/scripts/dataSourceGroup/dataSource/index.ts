...
export default {
    components: {
        ListData: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/dataSource/List.vue'),
            loadingComponent: SkeletonBox,
        }),
        AddData: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/dataSource/AddDataSource.vue'),
            loadingComponent: SkeletonBox,
        }),
        ModifyData: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/dataSource/ModifyDataSource.vue'),
            loadingComponent: SkeletonBox,
        }),
        ViewDetail: defineAsyncComponent({
            loader: () => import('@/views/dataSourceGroup/dataSource/ViewDetail.vue'),
            loadingComponent: SkeletonBox,
        }),
    },
    setup() {
