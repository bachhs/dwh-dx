...
export default {
    ...
    components : {
        SchemaView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/SchemaView.vue"),
            loadingComponent: SkeletonBox,
        }),
        SampleDataView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/SampleDataView.vue"),
            loadingComponent: SkeletonBox,
        }),
        ActivityFeedsAndTaskView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/ActivityFeedsAndTaskView.vue"),
            loadingComponent: SkeletonBox,
        }),
        QueriesView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/QueriesView.vue"),
            loadingComponent: SkeletonBox,
        }),
        ProfilerDataQualityView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/ProfilerDataQualityView.vue"),
            loadingComponent: SkeletonBox,
        }),
        LineageView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/LineageView.vue"),
            loadingComponent: SkeletonBox,
        }),
        CustomerPropertiesView: defineAsyncComponent({
            loader: () => import("@/views/dataSourceGroup/dataSource/tableDetail/CustomerPropertiesView.vue"),
            loadingComponent: SkeletonBox,
        }),
    },
