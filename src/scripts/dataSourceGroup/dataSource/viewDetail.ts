...
export default {
    ...
    components: {
        ...
        DatabaseList: defineAsyncComponent({
            loader: () =>
                import('@/views/dataSourceGroup/dataSource/viewDetails/DatabaseList.vue'),
            loadingComponent: SkeletonBox,
        }),
        SchemasList: defineAsyncComponent({
            loader: () =>
                import('@/views/dataSourceGroup/dataSource/viewDetails/SchemasList.vue'),
            loadingComponent: SkeletonBox,
        }),
        TablesAndViews: defineAsyncComponent({
            loader: () =>
                import('@/views/dataSourceGroup/dataSource/viewDetails/TablesAndViews.vue'),
            loadingComponent: SkeletonBox,
        }),
        TableDetails: defineAsyncComponent({
            loader: () =>
                import('@/views/dataSourceGroup/dataSource/viewDetails/TableDetails.vue'),
            loadingComponent: SkeletonBox,
        }),
        ColumnDetails: defineAsyncComponent({
            loader: () =>
                import('@/views/dataSourceGroup/dataSource/viewDetails/ColumnDetails.vue'),
            loadingComponent: SkeletonBox,
        }),
    },
    setup(props: any) {
