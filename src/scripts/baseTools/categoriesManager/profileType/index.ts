...
export default {
    components: {
        ListData: defineAsyncComponent({
            loader: () => import('@/views/baseTools/categoriesManager/profileType/List.vue'),
            loadingComponent: SkeletonBox,
        }),
        AddData: defineAsyncComponent({
            loader: () => import('@/views/baseTools/categoriesManager/profileType/Add.vue'),
            loadingComponent: SkeletonBox,
        }),
