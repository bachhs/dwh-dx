<script lang="ts" src="@/scripts/dashboard/dashboard.ts"></script>
            ...
            <div
                ...
                <div
                    ...
                    <el-scrollbar
                        ...
                        <label
                            class="d-block w-100 p-2 mb-2 mr-2"
                            v-for="(unitItem, indexUnit) in organization"
                            :key="indexUnit"
                            @click="
                                $router.push(
                                    `/data-source?organization=${unitItem.id}`
                                )
                            ">
                            <input
                                class="dataSourceUnit-radio d-none"
                                type="radio"
                                name="dataSourceUnitSelection"
                                :value="indexUnit"
                                v-model="indexSourceSelected" />
                            <div
                ...
                <div
                    ...
                    <el-scrollbar
                        class="flex-fill d-flex flex-column pl-2 pr-3 mb-2">
                        <div class="w-100">
                            <el-card
                                :body-style="{ padding: '0.5rem 0.5rem' }"
                                class="mb-2"
                                v-for="item in 20"
                                :key="item">
                ...
                <div
                    ...
                    <div class="flex-fill d-flex pl-4 pr-4">
                            ...
                            <div class="mb-5">
                                <el-card>
                                    <div class="text-center">
                                        <img
                                            :src="`/custom-img/svg-icon/database-icon.svg`"
                                            style="width: 3.5rem" />
                                    </div>
                                    <div
                                        ...
                                        style="line-height: 1.2rem">
                                        <strong
                                            >Data warehouse<br />Database</strong
                                        >
                                    </div>
                                </el-card>
                            </div>
                            <div>
                                <el-card>
                                    ...
                                    <div
                                        ...
                                        style="line-height: 1.2rem">
                                        <strong
                                            >Operational Data<br />Store(OOS)</strong
                                        >
                                    </div>
                                </el-card>
                            </div>
                        ...
                        <div
                            class="ml-4 d-flex flex-column align-items-center justify-content-center">
                            <div
                                v-for="item in 6"
                                :key="item"
                                class="mb-3 mt-3">
                                <el-card>
                                    <div
                                        class="text-center pl-1 pr-1 text-nowrap"
                                        style="line-height: 1.2rem">
                                        Data Mart
                                    </div>
                                </el-card>
                                ...
                                <div
                                    ...
                                    <el-card style="height: auto" class="m-2">
                                        <div class="pl-3 pr-3 w-100">
                                            <div class="dig-icon p-2">
                                                <img
                                                    src="/custom-img/svg-icon/finance-icon.svg"
                                                    style="width: 4rem" />
                                            </div>
                                            <div class="text-navy">
                                                <strong>{{ item }}</strong>
