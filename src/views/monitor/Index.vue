<template>
    <div class="position-relative d-flex flex-row h-100">
        <iframe class="w-100 h-100 position-absolute text-center"
            style="left: 0; top: 0; z-index: 10;"
            src="https://monitor.dtcsolution.vn/d/W5KDrdKnz/dtc-datalake-dashboard?orgId=1&kiosk&theme=light"
            height="100%"
            frameborder="0"></iframe>
        <div class="position-absolute text-center w-100 h-100 bg-white p-2 pl-3 pr-3 d-flex align-items-center justify-content-center" 
            style="left: 0; top: 0; border-radius: 10px; z-index: 1;">
            <div>
                <div>
                ...
                <div>
                    <h4><strong>Đang tải dữ liệu</strong></h4>
                </div>
            </div>
        </div>
    </div>
