...
<script lang="ts" src="@/scripts/baseTools/categoriesManager/profileType/list.ts"></script>
<template>
    <div class="flex-fill d-flex flex-column w-100" v-loading="isLoading">
        ...
        <div class="flex-fill d-flex flex-column w-100 pt-3 pb-0">
            <div
                ...
                v-if="profileType && profileType.length > 0">
                <el-scrollbar class="w-100 flex-fill">
                    <div class="mt-2 mr-3">
                        <table
                            ...
                            <tbody class=" ">
                                <tr v-for="(itemData, itemIndex) in profileType" :key="itemIndex">
                                    <td class="pl-2 text-left">{{itemIndex}}</td>
                                    <td class="pl-2">
                                        {{ itemData.name }}
                                    </td>  
