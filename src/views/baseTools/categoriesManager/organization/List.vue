...
<script lang="ts" src="@/scripts/baseTools/categoriesManager/organization/list.ts"></script>
<template>
                ...
                <el-scrollbar class="w-100 flex-fill">
                    <div class="mt-2 mr-3">
                        <table
                            ...
                            <tbody class=" ">
                                <tr v-for="(itemData, itemIndex) in organizations" :key="itemIndex">
