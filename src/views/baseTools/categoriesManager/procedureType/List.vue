...
<script lang="ts" src="@/scripts/baseTools/categoriesManager/procedureType/list.ts"></script>
<template>
    <div class="flex-fill d-flex flex-column w-100" v-loading="isLoading">
        ...
        <div class="flex-fill d-flex flex-column w-100 pt-3 pb-0">
            <div
                ...
                v-if="procedureType && procedureType.length > 0">
                        ...
                        <table
                            ...
                            <thead>
                                <tr class="bg-white">
                                    ...
                                    <th
                                        class="pl-0 pt-2 pb-2 text-center text-nowrap align-middle">
                            ...
                            <tbody class=" ">
                                <tr v-for="(itemData, itemIndex) in procedureType" :key="itemIndex">
