...
<script lang="ts" src="@/scripts/baseTools/categoriesManager/province/list.ts"></script>
<template>
                ...
                <el-scrollbar class="w-100 flex-fill">
                    <div class="mt-2 mr-3">
                        <table
                            ...
                            <thead>
                                <tr class="bg-white">
                                    ...
                                    <th class="pl-0 pt-2 pb-2 align-middle">
                                        <button>TÊN TỈNH/ THÀNH PHỐ</button>
                                    </th> 
                                    <th class="pl-0 pt-2 pb-2 align-middle">
                            ...
                            <tbody class=" ">
                                <tr v-for="(itemData, itemIndex) in provinces" :key="itemData.code">
