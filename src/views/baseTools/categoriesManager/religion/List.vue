...
<script lang="ts" src="@/scripts/baseTools/categoriesManager/religion/list.ts"></script>
<template>
    <div class="flex-fill d-flex flex-column w-100" v-loading="isLoading">
        ...
        <div class="flex-fill d-flex flex-column w-100 pt-3 pb-0">
            <div class="flex-fill d-flex flex-column"
                v-if="religions && religions.length > 0">
                <el-scrollbar class="w-100 flex-fill">
                    <div class="mt-2 mr-3">
                        <table
                            ...
                            <tbody class=" ">
                                <tr v-for="(itemData, itemIndex) in religions" :key="itemIndex">
