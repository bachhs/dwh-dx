		...
		<div class="d-flex mt-1">
			<div class="flex-fill d-flex flex-column m-1 mr-4 ml-0 p-2 rounded" style="border: 2px solid #e0e0e0; height: calc(100vh - 7.4rem); background-color: #f0f0f0;">
				...
				<div class="text-center flex-fill d-flex flex-column pl-2 pr-2">
					<div class="mb-4 flex-fill d-flex align-items-center justify-content-center pt-3 pb-3" style="border: 2px solid #e0e0e0; background-color: #fff;">
					...
					<div class="mb-2 flex-fill d-flex align-items-center justify-content-center pt-3 pb-3" style="border: 2px solid #e0e0e0; background-color: #fff;">
