<script lang="ts" src="@/scripts/datasourcePipeline/dataSet/index.ts"></script>
<template>
    <el-card
            ...
            <div class="d-flex align-items-center">
                <div class="flex-fill d-none d-md-block">
                    <h4>
                        ...
                        <strong>Tiến trình thu thập dữ liệu từ DataSet</strong>
                    </h4>
                </div>
                <div class="d-flex align-items-center">                    
                    <div class="ml-1">
                            ...
                            <tbody class=" ">
                                <tr v-for="itemDemo in 99" :key="itemDemo">
                                    <td class="p-0 text-left">
                                        <img src="/icons/databases/postgresql.svg"
                                            class="ml-1"
                                            style="height: 2.5rem;" />
                                    </td>
                                    <td class="pl-2">
