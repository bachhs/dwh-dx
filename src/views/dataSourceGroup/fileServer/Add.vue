<script lang="ts" src="@/scripts/dataSourceGroup/fileServer/add.ts"></script>
<template>
                ...
                <el-form
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div>
                                <div>
                                    <strong>Private key</strong><span class="ml-1 text-danger">*</span>
                                </div>
                                <div class="mt-2">
                                    <el-form-item label="">
                                        <el-input v-model="itemModel.privateKey" size="large" placeholder="Private key.."/>
                                    </el-form-item>
                                </div> 
                            </div> 
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div>
                                <div>
                                    <strong>Host</strong><span class="ml-1 text-danger">*</span>
                                </div>
                                <div class="mt-2">
                                    <el-form-item label="">
                                        <el-input v-model="itemModel.host" size="large" placeholder="Host.."/>
                                    </el-form-item>
                                </div> 
                            </div> 
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div>
                                <div>
                                    <strong>Port</strong><span class="ml-1 text-danger">*</span>
                                </div>
                                <div class="mt-2">
                                    <el-form-item label="">
                                        <el-input v-model="itemModel.port" size="large" placeholder="Port.."/>
                                    </el-form-item>
                                </div> 
                            </div> 
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div>
                                <div>
                                    <strong>Username</strong><span class="ml-1 text-danger">*</span>
                                </div>
                                <div class="mt-2">
                                    <el-form-item label="">
                                        <el-input v-model="itemModel.username" size="large" placeholder="Username.."/>
                                    </el-form-item>
                                </div> 
                            </div> 
                        </div>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div>
                                <div>
                                    <strong>Password</strong><span class="ml-1 text-danger">*</span>
                                </div>
                                <div class="mt-2">
                                    <el-form-item label="">
                                        <el-input v-model="itemModel.password" size="large" placeholder="Password.."/>
                                    </el-form-item>
                                </div> 
                            </div> 
                        </div>
